    ...
    return (
        <div className="flex flex-col text-white p-8">
            <div className='cards-container flex flex-col gap-7 mb-20 '>
                <h1 className='text-4xl font-semibold'>Simple projects</h1>
                <div className='w-auto inline-flex flex-nowrap mx-10 overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]'>
            ...
            <div className='cards-container flex flex-col gap-7'>
                <h1 className='text-4xl font-semibold'>Cibersecurity projects</h1>
                <div className='w-auto inline-flex flex-nowrap mx-10 overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]'>
                    <div className='w-auto flex items-center justify-center md:justify-start group-hover:animation-pause [&_.projectCard]:mx-8 [&_img]:max-w-none animate-infinite-scroll '>
                        {securityProjects.map((project, index) => (
                            <ProjectCard
